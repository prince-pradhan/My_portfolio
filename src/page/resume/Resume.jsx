      ...
      <div style={{ width: "100%", display: "flex" }}>
        <div style={{ width: "50%", padding: "8px" }}>
          <EDUEXPUI
            ...
            img={Experience}
            logoImg={LR}
            desc="  Legal Remit Nepal introduced its groundbreaking real-time service for Nepal. 
            Our innovative platform allows people to send money from Australia to Nepal in less than 2 minutes. 
           "
          />
        </div>
        <div
