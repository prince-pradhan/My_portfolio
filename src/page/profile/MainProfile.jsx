        ...
        >
          ...
          >
            <FaFacebook
              ...
              onClick={() =>
                window.open("https://www.facebook.com/princepradhan01", "_blank")
              }
            />
            <FiInstagram
              ...
              onClick={() =>
                window.open(
                  "https://www.instagram.com/princepradhan3/",
                  "_blank"
                )
              }
            />
            ...
            <FaGithub
              ...
              onClick={() =>
                window.open("https://github.com/prince-pradhan", "_blank")
              }
            />
          </div>
        </div>
